...
| 2026-09-23 | Nod-gesture rewrite: never assign Euler components after lookAt — lookAt emits (-PI,yaw,-PI) form, overwriting .x destroys the equivalence and buries the speaker upside-down; nod now premultiplies a small quaternion onto a saved baseQuat | Root-caused the "vanishing speaker": every speaker got π-flipped underground; fix verified — all three adi-01 sages stand with faces | Accepted |
