...
| 2026-09-23 | Nutcracker fix: sage v2 joins torso+limbs+neck into one auto-weighted skinned body (rigid segments read assembled), bigger eyes, thicker limbs, neck bridge; ported limb/neck/eye pattern to kit; player tint handles multi-material meshes | Segments with gaps read as wooden puppets; interpenetration + skinning reads organic | Accepted |
