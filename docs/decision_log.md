...
| 2026-09-23 | Sage smoothing pass: tiered Subsurf (L2 hero masses/L1 details, baked via export_apply), skin subsurface 0.35, human proportions (shorter torso, longer arms), shawl box->rounded roll; flight shortened 0.18->0.10 + lift 2.6 so camera stops inside the fire | Faceted primitives read 2000s; smooth clay-toon is the Bheem bar | Accepted |
